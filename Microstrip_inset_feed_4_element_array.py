...
offset = 60 # Offset between edges of 2 successve patches
...
phase_delay_time = abs((phase_delay)/360)*(1/centre_frequency)
SimBox = np.array([160, 80, 92]) # Array for creating simulation box
...
FDTD = openEMS(NrTS=60000, CoordSystem=0, EndCriteria=1e-6) # Object FDTD is created/instantiated for the class openEMS, set number of time steps to 60000 and set energy decay criteria to be 0.000001
